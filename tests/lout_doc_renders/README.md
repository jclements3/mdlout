...
|-----|------:|---:|----:|----:|-----:|--------:|---------:|------------:|------:|
| [design](./design.html) | 40 | 431.9 KiB | [173.5 KiB](./design.pdf) | 2.3 MiB | [2.3 MiB](./design.html) | 3s | 6s | 0.6560 | 14.27% |
| [expert](./expert.html) | 120 | 937.5 KiB | [496.0 KiB](./expert.pdf) | 5.9 MiB | [5.9 MiB](./expert.html) | 20s | 22s | 0.9202 | 6.71% |
| [slides](./slides.html) | 42 | 150.3 KiB | [73.0 KiB](./slides.pdf) | 262.7 KiB | [264.6 KiB](./slides.html) | 3s | 2s | 0.9804 | 1.68% |
| [user](./user.html) | 327 | 4.5 MiB | [1.6 MiB](./user.pdf) | 18.1 MiB | [18.1 MiB](./user.html) | 201s | 224s | 0.9288 | 7.74% |
...
3. **Per-pass output alternation continues.** With 7 passes, every doc's SVG run alternates between the full multi-page output and a smaller partial output on each pass — the same phenomenon `tests/user_guide_diff.sh` already documents. We pick the biggest of the seven by file size as the canonical output. (`design` peaks on pass 2, `expert` on pass 4, `slides` on pass 2, `user` on pass 4.)
