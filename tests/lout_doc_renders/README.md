...
```bash
bash tests/lout_doc_renders/build.sh                       # default 100 dpi diff pass
DPI=150 bash tests/lout_doc_renders/build.sh               # 150 dpi rerun (#172 DPI insight)
SKIP_DOC_BUILD=1 DPI=150 bash tests/lout_doc_renders/build.sh   # reuse /tmp/*.{ps,svg}, just rerun the diff stage
```
